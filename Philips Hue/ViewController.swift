...
class ViewController: UITableViewController {
    ...
    let alert = UIAlertController(title: "No connection found", message:"Can't connect to a Philips Hue Bridge.", preferredStyle: .alert)
    ...
    override func viewDidLoad() {
        ...
        {
            title = "Home"
            url = "http://192.168.1.25/api/7fhuy-WsU2PWUaHh6SQslkyGpCIqpjlh1jFewoQt/lights/"
        }
